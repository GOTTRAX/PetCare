...
<head>
    ...
    <style>
        ...
        * {
        ...
        .fc .fc-toolbar { padding: 6px 8px; background: var(--white); border-radius: 6px; box-shadow: var(--shadow-sm); margin-bottom: 6px; }
        .fc .fc-toolbar-title { font-size: 0.95rem; font-weight: 600; color: var(--gray-900); }
        .fc .fc-button { background: var(--primary) !important; border: none !important; color: var(--white) !important; border-radius: 5px !important; padding: 4px 10px !important; font-weight: 600 !important; font-size: 0.7rem !important; }
        .fc .fc-button:hover { background: var(--primary-dark) !important; }
        .fc .fc-daygrid-day-frame { min-height: 85px !important; }
        .fc .fc-col-header-cell { padding: 8px 2px !important; font-size: 0.75rem !important; font-weight: 700 !important; }
        .fc .fc-daygrid-day-number { padding: 4px 6px !important; font-size: 0.85rem !important; font-weight: 600 !important; }
        ...
        .fc-event.confirmado { background-color: var(--success) !important; }
        .fc-event.cancelado { background-color: var(--danger) !important; text-decoration: line-through; }
        .fc-event.pendente { background-color: var(--warning) !important; color: var(--gray-900) !important; }
        .fc-event.finalizado { background-color: var(--gray-600) !important; }
        .fc-daygrid-day:hover { background-color: var(--gray-50) !important; }
        ...
        .form-control, select, textarea, input[type="date"], input[type="time"] {
            width: 100%;
            padding: 8px 10px;
        ...
        .animal-card:hover { border-color: var(--primary-light); background: var(--gray-100); }
        .animal-card.selected { border-color: var(--primary); background: var(--primary-light); color: var(--white); box-shadow: var(--shadow-md); }
        ...
        .animal-image i { font-size: 24px; color: var(--gray-500); }
        .animal-name { font-weight: 600; font-size: 0.8rem; }
        ...
        .preco-info.feriado .preco-valor { color: #b45309; }
        .preco-valor i { font-size: 1.4rem; color: #6366f1; }
        .preco-info.feriado .preco-valor i { color: #f59e0b; }
        ...
        .preco-tipo::before { content: '▸'; color: #6366f1; font-size: 0.875rem; font-weight: 900; }
        .preco-info.feriado .preco-tipo { color: #92400e; }
        .preco-info.feriado .preco-tipo::before { color: #f59e0b; }
        ...
        .duracao-info i { color: var(--primary); font-size: 1rem; }
        ...
        .solicitacao:hover { border-color: var(--primary); background: var(--white); box-shadow: var(--shadow-sm); }
        .solicitacao-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
        .solicitacao-header strong { font-size: 0.8rem; color: var(--gray-900); }
        .solicitacao-info { font-size: 0.75rem; color: var(--gray-600); margin-bottom: 4px; }
        .solicitacao-actions { display: flex; gap: 8px; margin-top: 8px; }
        .solicitacao-actions button { flex: 1; padding: 6px; border: none; border-radius: 4px; cursor: pointer; font-size: 0.8rem; font-weight: 600; transition: all 0.2s; }
        .solicitacao-actions .aceitar { background: #d1fae5; color: var(--success); }
        .solicitacao-actions .recusar { background: #fee2e2; color: var(--danger); }

        #contador-solicitacoes { background: var(--danger); color: var(--white); padding: 2px 5px; border-radius: 8px; font-size: 0.65rem; font-weight: 600; margin-left: 5px; display: none; }
        #contador-solicitacoes.show { display: inline; }
    ...
    <div class="container">
        ...
        <div id="modalCancelamento" class="modal-overlay">
            <div class="modal-box">
                ...
                <p style="font-size: 0.85rem; color: #666; margin-bottom: 12px;">Por favor, explique por que deseja cancelar este agendamento:</p>
                <textarea id="motivo-input" class="form-control" placeholder="Descreva o motivo do cancelamento..." required></textarea>
                    ...
                    <div id="tab-novo" class="tab-content active">
                        <form id="formAgendamento">
                                ...
                                <div class="animals-grid">
                                    ...
                                    <div class="animal-card" data-id="<?= $animal['id'] ?>">
                                        <div class="animal-image">
                                            ...
                                            <img src="<?= UPLOAD_URL . htmlspecialchars($animal['foto']) ?>" alt="<?= htmlspecialchars($animal['nome']) ?>" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="observacoes" id="observacoes" class="form-control" placeholder="Digite suas observações..."></textarea>
                            </div>
