                    ...
                    <li class="user-menu">
                        <div class="user-name-container">
                            ...
                            <div class="dropdown-menu">
                                <a href="<?php echo $base_path; ?>PHP/Cliente/perfil.php?aba=informacoes"
                                    class="<?php echo $perfil_active; ?>">Perfil</a>
                                <a href="<?php echo $base_path; ?>PHP/Cliente/perfil.php?aba=configuracoes"
                                    class="<?php echo $configuracoes_active; ?>">Configurações</a>
                                <a href="<?php echo $base_path; ?>PHP/Cliente/perfil.php?aba=pets"
                                    class="<?php echo $pets_active; ?>">Pets</a>
                                <a href="<?php echo $base_path; ?>PHP/Cliente/perfil.php?aba=agendamentos"
                                    class="<?php echo $agendamento_active; ?>">Agendamentos</a><a
                                    href="<?php echo $base_path; ?>PHP/logout.php" class="logout">Sair</a>
                            </div>
                        </div>
                    </li>
